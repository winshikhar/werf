...
`))
			...
			Entry("the dockerfile not found", entry{
				expectedErrSubstring: "unable to read the dockerfile: the file 'Dockerfile' not found in the project git repository",
			}),
			Entry("the dockerfile not committed", entry{
				addDockerfile:        true,
				expectedErrSubstring: "unable to read the dockerfile: the file 'Dockerfile' must be committed",
			}),
			...
			Entry("the dockerfile committed, the dockerfile changed", entry{
				...
				expectedErrSubstring:        "unable to read the dockerfile: the file 'Dockerfile' changes must be committed",
			}),
			...
			Entry("config.dockerfile.allowContextAddFiles (Dockerfile) does not cover the dockerfile 'Dockerfile' inside context 'context'", entry{
				...
				context:                              "context",
				addDockerfile:                        true,
				expectedErrSubstring:                 "unable to read the dockerfile: the file 'context/Dockerfile' must be committed",
			}),
...
`))
			...
			Entry("the dockerignore not committed", entry{
				...
				expectedErrSubstring: "unable to read the dockerignore file: the file '.dockerignore' must be committed",
			}),
			...
			Entry("the dockerignore committed, the dockerignore changed", entry{
				...
				expectedErrSubstring:          "unable to read the dockerignore file: the file '.dockerignore' changes must be committed",
			}),
			...
			Entry("config.dockerignore.allowContextAddFiles (.dockerignore) does not cover the dockerignore '.dockerignore' inside context 'context'", entry{
				...
				context:              "context",
				addDockerignore:      true,
				expectedErrSubstring: "unable to read the dockerignore file: the file 'context/.dockerignore' must be committed",
			}),
