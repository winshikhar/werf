...
func GetOptionalWerfConfig(ctx context.Context, projectDir string, cmdData *CmdData, manager giterminism.Manager, opts config.WerfConfigOptions) (*config.WerfConfig, error) {
	...
	if customWerfConfigRelPath != "" {
		...
		c, err := config.GetWerfConfig(ctx, customWerfConfigRelPath, customWerfConfigTemplatesDirRelPath, manager, opts)
...
func GetRequiredWerfConfig(ctx context.Context, projectDir string, cmdData *CmdData, manager giterminism.Manager, opts config.WerfConfigOptions) (*config.WerfConfig, error) {
	customWerfConfigRelPath, err := GetCustomWerfConfigRelPath(projectDir, cmdData)
	if err != nil {
		return nil, err
	}
	...
	return config.GetWerfConfig(ctx, customWerfConfigRelPath, customWerfConfigTemplatesDirRelPath, manager, opts)
}
