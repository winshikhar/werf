...
func (repo *Base) createVirtualMergeCommit(gitDir, path, workTreeCacheDir string, fromCommit, toCommit string) (string, error) {
	...
	return true_git.CreateTemporaryMergeCommit(gitDir, workTreeCacheDir, fromCommit, toCommit, true_git.CreateTemporaryMergeCommitOptions{HasSubmodules: hasSubmodules})
}
